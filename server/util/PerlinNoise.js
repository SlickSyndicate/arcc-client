...
function generateWhiteNoise(seed, width, height) {
  let generator = new RandomSeed(seed);
  var noise = new Array(width * height);
  for (var i = 0; i < noise.length; ++i) {
    noise[i] = generator.random();
  }
  return noise;
}
